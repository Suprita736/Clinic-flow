  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium cursor-pointer transition-all focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 disabled:cursor-not-allowed [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "rounded-full bg-primary text-primary-foreground shadow-card hover:shadow-elevated hover:-translate-y-0.5",
        pill: "rounded-full bg-primary text-primary-foreground shadow-soft hover:bg-primary/90",
        pillOutline:
          "rounded-full border border-primary/25 bg-card text-foreground shadow-soft hover:bg-accent",
        mint: "bg-mint text-mint-foreground shadow-soft hover:opacity-90",
      },
      size: {
